...
namespace NLog.Targets
{
    ...
    public sealed class EventHubTarget : AsyncTaskTarget
    {
        ...
        /// <summary>
        /// clientId for <see cref="Azure.Identity.ClientSecretCredential"/> OAuth2 authentication. Requires <see cref="ServiceUri"/>, <see cref="TenantIdentity"/> and <see cref="ClientAuthSecret"/>.
        /// </summary>
        public Layout ClientAuthId { get; set; }

        /// <summary>
        /// clientSecret for <see cref="Azure.Identity.ClientSecretCredential"/> OAuth2 authentication. Requires <see cref="ServiceUri"/>, <see cref="TenantIdentity"/> and <see cref="ClientAuthId"/>.
        /// </summary>
